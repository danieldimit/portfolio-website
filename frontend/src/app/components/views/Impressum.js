        ...
        return (
            <div>
                ...
                <div className='container-content-page'>
                    ...
                    <p>Tomasz Henryk Tkaczyk<br/>
                        Tauroggener Str 37<br/>
                        10589 Berlin <br/>
                    </p>
                    ...
                    <p> <strong>Vertreten durch: </strong><br/>
                        ...
                        Daniel Dimitrov<br/>
                        Lasse Todt<br/>
                        Magdalena Trzeciak<br/>
                        Marion Stefanie Erle<br/>
                        Wladimir Silantiy Leuschner<br/>

                </p>
                    <p><strong>Kontakt:</strong> <br/>
                    Telefon: +49 152 53390797<br/>
                    E-Mail: <a href='mailto:kontakt@fakenewsgraph.de'>kontakt@fakenewsgraph.de</a>
                    <br/></p>
                    ...
                    Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit,
                        ...
                        werden wir diese Inhalte umgehend entfernen.<br/><br/><strong>Haftung für Links</strong><br/><br/>
                    Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben.
                        ...
                        Links umgehend entfernen.<br/><br/><strong>Urheberrecht</strong><br/><br/>
                    ...
                    <br/><br/><strong>Google Analytics</strong><br/><br/>
                        Diese Website benutzt Google Analytics, einen Webanalysedienst der Google Inc. (''Google'').
                            ...
                            (einschließlich Ihrer IP-Adresse) wird an einen Server von Google in den USA übertragen
                            ...
                            übertragen, sofern dies gesetzlich vorgeschrieben oder soweit Dritte diese Daten im Auftrag
                            von Google verarbeiten. Google wird in keinem Fall Ihre IP-Adresse mit anderen Daten der Google
                            in Verbindung bringen. Sie können die Installation der Cookies durch eine entsprechende
                            Einstellung Ihrer Browser Software verhindern; wir weisen Sie jedoch darauf hin, dass
                            Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website voll umfänglich
                            nutzen können. Durch die Nutzung dieser Website erklären Sie sich mit der Bearbeitung der
                            über Sie erhobenen Daten durch Google in der zuvor beschriebenen Art und Weise und zu dem
                            zuvor benannten Zweck einverstanden.</p><br/>
                    Website Impressum erstellt durch <a href="http://www.impressum-generator.de">impressum-generator.de</a> von der
                    <a href="http://www.kanzlei-hasselbach.de/"> Kanzlei Hasselbach, Bonn</a>
                </div>
                <Footer />
            </div>
        );
